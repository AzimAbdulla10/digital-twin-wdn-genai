  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
      ...
      <div className="lg:col-span-5 flex flex-col gap-6">
        ...
        {/* Telemetry Inspector */}
        <div className="bg-[#000000]/90 rounded-lg border border-zinc-800 p-5 flex flex-col ">
          <div className="flex items-center gap-2 mb-3">
            <div className="p-1.5 rounded-lg bg-indigo-500/10 text-indigo-400 border border-indigo-500/20">
              <Layers className="w-4 h-4" />
            </div>
            <div>
              <h3 className="text-sm font-semibold text-zinc-100">Telemetry Inspector</h3>
              <p className="text-xs text-zinc-400">Live element hydraulics at {currentTimestep}:00</p>
            </div>
          </div>

          {selectedNode ? (
            <div className="grid grid-cols-2 gap-3 text-xs">
              <div className="bg-[#09090b]/90 p-3 rounded-md border border-zinc-800">
                <span className="text-zinc-400 block mb-1">Selected Element</span>
              ...
              <div className="bg-[#09090b]/90 p-3 rounded-md border border-zinc-800">
                <span className="text-zinc-400 block mb-1">Elevation</span>
              ...
              <div className="bg-[#09090b]/90 p-3 rounded-md border border-zinc-800">
                <span className="text-zinc-400 block mb-1">Live Pressure</span>
                <span
              ...
              <div className="bg-[#09090b]/90 p-3 rounded-md border border-zinc-800">
                <span className="text-zinc-400 block mb-1">Base Demand</span>
                <span className="font-mono font-bold text-zinc-200 text-sm">
            ...
            <div className="grid grid-cols-2 gap-3 text-xs">
              <div className="bg-[#09090b]/90 p-3 rounded-md border border-zinc-800">
                <span className="text-zinc-400 block mb-1">Link ID</span>
                <span className="font-mono font-bold text-zinc-200 text-sm">
              ...
              <div className="bg-[#09090b]/90 p-3 rounded-md border border-zinc-800">
                <span className="text-zinc-400 block mb-1">Flow Rate</span>
                <span className="font-mono font-bold text-cyan-300 text-sm">
              ...
              <div className="bg-[#09090b]/90 p-3 rounded-md border border-zinc-800">
                <span className="text-zinc-400 block mb-1">Diameter</span>
                <span className="font-mono font-bold text-zinc-200 text-sm">
              ...
              <div className="bg-[#09090b]/90 p-3 rounded-md border border-zinc-800">
                <span className="text-zinc-400 block mb-1">Length</span>
                <span className="font-mono font-bold text-zinc-200 text-sm">
